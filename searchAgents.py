...
#             print unCorner
            ...
            if not hitsWall:
                if (nextx, nexty) == self.corners[0]:
                    unCorner = unCorner & 0b1110  #eat 0 corner
                if (nextx, nexty) == self.corners[1]:
                    unCorner = unCorner & 0b1101  #eat 1st corner
                if (nextx, nexty) == self.corners[2]:
                    unCorner = unCorner & 0b1011
                if (nextx, nexty) == self.corners[3]:
                    unCorner = unCorner & 0b0111
                successors.append((((nextx,nexty),unCorner),action,1))
